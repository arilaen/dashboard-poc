...
import application_configuration from '../src/common/server-config'
...
const javascript_loader = configuration.module.loaders.find(loader =>
{
...
const development_server = new koa()

development_server.use(require('koa-webpack-dev-middleware')(compiler, development_server_options))
development_server.use(require('koa-webpack-hot-middleware')(compiler))

development_server.listen(application_configuration.development.webpack.development_server.port, (error) =>
{
	if (error)
	{
		console.error('error building development server', error.stack || error)
		throw error
	}
